...
## 🧩 Problem Statement
Most online stores rely on third-party solutions for backend services, which can limit flexibility, security, and scalability. Merchants need a **secure, customizable, and self-hosted backend** to manage users, orders, and payments efficiently.  
...
- 📜 **View all orders** and **user-specific data access**  
